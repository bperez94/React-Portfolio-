      ...
      return(
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            ...
            <CardActions border>
              <a href="https://github.com/bperez94/esports-tournament-tracker"  class="active"><Button colored>GitHub</Button></a>
              <a href="https://bperez94.github.io/esports-tournament-tracker/"  class="active"><Button colored>Deployed</Button></a>
            </CardActions>
